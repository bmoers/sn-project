...
function mkdirpAsync(fullPath) {
    return mkdirp.mkdirpAsync(getDirName(fullPath));
}
exports.mkdirpAsync = mkdirpAsync;

function writeFileAsync(fullFilePath, contents) {
    return mkdirp.mkdirpAsync(getDirName(fullFilePath)).then(function () {
